...
// All pages live under /dashboard/ — URLs match the file structure
...
export const bottomPrimaryKeys = ['home', 'receiving', 'scan', 'inventory', 'damaged'];
export const bottomSecondaryKeys = ['expiry', 'products', 'import', 'reports', 'notifications', 'barcode', 'settings', 'roles', 'audit'];
